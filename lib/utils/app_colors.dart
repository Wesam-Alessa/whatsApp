...
class AppColors {
  static const Color whatsUpPrimaryColor = Color(0xFF075E54);
  static const Color whatsUpAccentColor = Color(0xFF128C7E);
  static const Color whatsUpCardMessageColor = Color(0xFFdcf8c6);
